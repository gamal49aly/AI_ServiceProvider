      ...
      <div class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16 relative z-10">
        <div class="w-full max-w-md space-y-8 animate-fade-in-up">
          ...
          <div class="text-center lg:text-left">
            ...
            <h2 class="text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight mb-2">Welcome Back</h2>
            <p class="text-slate-500 dark:text-slate-400 text-lg">Please enter your details to sign in.</p>
          </div>
            ...
            <div class="space-y-5">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                  ...
                  <label for="remember" class="text-sm text-slate-600 dark:text-slate-400 cursor-pointer select-none">Remember for 30 days</label>
                </div>
                <a class="text-sm font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 cursor-pointer">Forgot password?</a>
              </div>
            </div>

            <button pButton label="Sign In" class="w-full p-button-lg bg-indigo-600 border-indigo-600 hover:bg-indigo-700 shadow-lg shadow-indigo-200 dark:shadow-none" 
                    [loading]="loading" type="submit"></button>

            <div class="text-center mt-6">
               <p class="text-slate-600 dark:text-slate-400">
                 Don't have an account? 
                 <a routerLink="/pages/register" class="font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 transition-colors cursor-pointer">Sign up for free</a>
               </p>
            </div>
          </form>
        </div>
